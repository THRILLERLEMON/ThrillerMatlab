...
NCfur_pt = 'E:\\OFFICE\\MTE_NEE_DATA\\1961 - 2010年期间新的历史全球氮肥施用图\\FAOSTAT_ver1\\TN_input_1961_2010.nc4';
outpt = 'E:\\OFFICE\\MTE_NEE_DATA\\1961 - 2010年期间新的历史全球氮肥施用图\\FAOSTAT_ver1\\TN_input_1961_2010_TIFF';
%NC数据的起始年
NCy = 1961;
%要使用的NC数据的变量名称
vstr = 'Annual N fertilizer rates as country average';
...
hds = 'Annual_N_fertilizer_rates_as_country_average';
for yr = yrs(1):yrs(2)
