...
for i = 1:length(RHead)
    ...
    mteadd20perY = mtepredict(bestMTE, add20perSplitX, add20perRegressX, binCat);
    ...
    mtemin20perY = mtepredict(bestMTE, min20perSplitX, min20perRegressX, binCat);
    ...
    xlswrite([outPutPath,'MTE_Susceptibility_RegressSplitVar_',char(RHead(i)),'.xls'], [infoHead,'PredictStandardY','Predictadd20perY','Predictmin20perY';info_rawData,num2cell(PredictStandardY),num2cell(Predictadd20perY),num2cell(Predictmin20perY)]);
